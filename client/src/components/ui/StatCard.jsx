    ...
    <div className="stat-card group">
      <div className="flex items-start justify-between gap-3">
        ...
        {trendValue !== undefined && (
          <span className={`flex max-w-[8rem] items-center gap-0.5 text-right text-[11px] font-semibold leading-tight ${isUp ? 'text-emerald-500' : 'text-red-500'}`}>
      ...
      <div>
        <p className="text-xl font-bold text-slate-900 dark:text-white sm:text-2xl">{value}</p>
